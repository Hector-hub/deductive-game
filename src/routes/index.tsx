  ...
  useClientEffect$(async () => {
    ...
    if (screen.width < width && state.isShowingMsg === false) {
      ...
      Swal.fire({
        icon: `error`,
        title: "Oops...",
        text: "La resolución de tu pantalla no es suficiente para visualizar este juego de forma adecuada. Gira la tu dispositivo para verificar si es posible visualizarlo.",
        footer: `Te recomiendo este juego: <a href="https://counterclick-thegame.web.app/">Counter Click The Game</a>`,
      });
      setTimeout(() => {
        Swal.fire({
          title:
            'También puede visitar mi página web: <a href="https://hecrey.000webhostapp.com/">hecrey.com</a>',
          width: 600,
          padding: "3em",
          color: "#716add",
          background:
      ...
      setTimeout(() => {
        if (screen.width < width) {
          Swal.fire({
            title:
              "Que mal, no dispones de la resolución suficiente, te recomiendo utilizar otro dispositivo. Adiós.",
            text: `Esta página se autodestruirá en 5 segundos.`,
            imageUrl:
